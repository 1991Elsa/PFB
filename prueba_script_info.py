...
nasdaq_tickers_historic = pd.DataFrame()
...
for ticker in tickers_nasdaq:
    ...
    #creamos df de info de todos los tickers
    nasdaq_tickers_info = pd.concat([nasdaq_tickers_info, df], ignore_index=True)

    #creamos df de todos los historicos
    nasdaq_tickers_historic = pd.concat([nasdaq_tickers_historic, ticker_historic], ignore_index=True, axis=1)
