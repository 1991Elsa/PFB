...
def clustering_process(engine, nasdaq_tickers_historic):
        ...
        try:
                ...
                #nasdaq_tickers_historic = nasdaq_tickers_historic[nasdaq_tickers_historic["Date"] <= pd.Timestamp("2023-03-01")]
                ...
                nasdaq_tickers_historic.drop(["Ticker", "Date", "Volume"], axis=1, inplace=True)
                ...
                dbscan = DBSCAN(eps=0.2, min_samples=2*X.shape[1])
                dbscan.fit(X)
